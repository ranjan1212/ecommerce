...
$sql = "SELECT * FROM product WHERE item_id=$items";
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-row pt-4 font-size-16 font-baloon">
                                <div class="col">
                                    <button type="submit" class="btn btn-danger form-control"><a href="cart.php">Proceed to Buy</a></button>
                                </div>
                                <div class="col">
                                    ...
                                    <button type="submit" name="Add_To_Cart" class="btn btn-warning form-control">Add to cart</a></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 py-5">
                            <h5 class="font-baloon font-size-20"><?php echo $row['item_name'] ?></h5>
                            <small><?php echo $row['item_brand'] ?></small>
                            <div class="d-flex">
                                ...
                                <a href="#" class="px-2 font-rale font-size-14">
                                    20,543 ratings | 1000+ answered questions
                                </a>
                            </div>
                            <hr class="m-0">
                            ...
                            <table class="my-3">
                                ...
                                <tr class="font-rale font-size-14">
                                    ...
                                    <td class="font-size-20 text-danger">
                                        $<span class="font-size-16 text-danger"> 5.00</span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div id="policy">
                                <div class="d-flex">
                                    <div class="return text-center mr-5">
                                        <div class="fonts-aize-20 my-2 color-second">
                                            <span class="fas fa-retweet border p-3 rounded-pill">
                                            </span>
                                        </div>
                                        <a href="#" class="font-rale.font-size-12">Daily Tuition <br>Deliverd</br></a>
                                    </div>
                                    <div class="return text-center mr-5">
                                        <div class="fonts-size-20 my-2 color-second">
                                            <span class="fas fa-truck border p-3 rounded-pill"></span>
                                        </div>
                                        <a href="#" class="font-rale.font-size-12">10 Days <br>Replacement</br></a>
                                    </div>
                                    <div class="return text-center mr-5">
                                        <div class="fonts-size-20 my-2 color-second">
                                            <span class="fas fa-check-double border p-3 rounded-pill"></span>
                                        </div>
                                        <a href="#" class="font-rale font-size-14">1 Year <br>Warranty</br></a>
                                    </div>
                                </div>
                                ...
                                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                                    ...
                                    <small>Sold By <a href="#">Jersey Nepal</a>.45 out of 5 | 18,198 ratings</small>
                                    <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Deliver to Customer - 244201</small>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <hr>
                            <p class="font-rale font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque molestias maxime laboriosam. Alias doloribus laboriosam illum doloremque consectetur. Non nobis quisquam perspiciatis officia sit, unde maxime et minima asperiores laboriosam.</p>
                            <p class="font-rale font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque molestias maxime laboriosam. Alias doloribus laboriosam illum doloremque consectetur. Non nobis quisquam perspiciatis officia sit, unde maxime et minima asperiores laboriosam.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="owl-carousel owl-theme" id="owl-theme">
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/jventus.jpg" alt="product" class="img-fluid">
                    </a>
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/Barcelona.jpg" alt="product" class="img-fluid">
                    </a>
                    <div class="text-center">
                        <h6>
                            Barcelona Jersey
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/city.jpg" alt="product" class="img-fluid">
                    </a>
                    <div class="text-center">
                        <h6>
                            ManCity Jersey
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/psg.jpg" alt="product" class="img-fluid">
                    </a>
                    <div class="text-center">
                        <h6>
                            PSG Jersey
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/amadrid.jpg" alt="product" class="img-fluid">
                    </a>
                    <div class="text-center">
                        <h6>
            ...
            <div class="item py-2">
                <div class="product font-rale">
                    <a href="#">
                        <img src="./assets/real madrid.jpg" alt="product" class="img-fluid">
                    </a>
                    <div class="text-center">
                        <h6>
                            Real Madrid Jersey
